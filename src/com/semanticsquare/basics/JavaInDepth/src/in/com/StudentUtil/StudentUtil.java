...
public class StudentUtil {
    public static double[] calculateGPA(int[] studentIdList, char[][] studentsGrades) throws MissingGradeException {
        ...
        if(studentsGrades.length != studentIdList.length){
            throw new IllegalArgumentException("studentIdList & studentsGrades are out-of-sync. "
                    + "studentIdList.length: "+ studentIdList.length + ", studentsGrades.length: "
    ...
    public static int[] getStudentsByGPA(double lower, double higher, int[] studentIdList, char[][] studentsGrades)
        ...
        // Your code: catch MissingGradeException and re-throw runtime exception InvalidDataException initialized
        // with the cause MissingGradeException
